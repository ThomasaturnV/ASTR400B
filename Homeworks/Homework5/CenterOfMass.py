...
# of a given galaxy and simulation snapshot
    ...
    def COMdefine(self,a,b,c,m):
        ...
        # For Loop to determine Total Mass (denomiator of eq 1 in Hw) #
        TotalMass = 0
        for mass in m:
            TotalMass += mass
        
        # For loop to determine weighted position for a (1st vector component)
        WeightedPos_a = 0
        for index in range(0, len(a)):
            pos = a[index]
            mass = m[index]
            
            WeightedPos_a += (pos * mass)
        
        # For loop to determine weighted position for b (2nd vector component)
        WeightedPos_b = 0
        for index in range(0, len(b)):
            pos = b[index]
            mass = m[index]
            
            WeightedPos_b += (pos * mass)
            
        # For loop to determine weighted position for c (3rd vector component)
        WeightedPos_c = 0
        for index in range(0, len(c)):
            pos = c[index]
            mass = m[index]
            
            WeightedPos_c += (pos * mass)
